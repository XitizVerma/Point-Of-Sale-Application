    ...
    <fo:root>
      ...
      <fo:page-sequence master-reference="simpleA4">
        <fo:flow flow-name="xsl-region-body">
          ...
          <fo:block font-size="12pt" text-align="right" font-family="Helvetica" font-weight="bold"
                    space-after="5mm">
            Order Time -
          ...
          <fo:block font-size="10pt">
            <fo:table table-layout="fixed" width="100%" border-collapse="separate">
              ...
              <fo:table-header font-weight="bold">
                ...
                <fo:table-cell border="1pt solid black" xsl:use-attribute-sets="tableBorder">
                  <fo:block font-size="15pt" text-align="center" font-weight="bold">Order Id
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell border="1pt solid black" xsl:use-attribute-sets="tableBorder">
                  <fo:block font-size="15pt" text-align="center" font-weight="bold">Order Item Id
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell border="1pt solid black" xsl:use-attribute-sets="tableBorder">
                  <fo:block font-size="15pt" text-align="center" font-weight="bold">Barcode
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell border="1pt solid black" xsl:use-attribute-sets="tableBorder">
